...
//	/**
//	 * 
//	 * @param mode "apk" if the input is an APK, "pkg": if the app is alredy installed
//	 * @param arg  Path of the apk to be installed or the package name if it is already installed
//	 */
...
///////////// copy  /////////////////
	...
	public void databases(String param,boolean isCopy){
		...
		if (param == null ||param.equals("e") || param.equals("encryption")){
			...
			this.dbTest.testDBAllFiles(TicklerVars.dataDir);
			}
		
		else if (param.equals("l") || param.equals("list")){
			this.dbTest.listDatabases(TicklerVars.dataDir);
		}
		else if (param.equals("d") || param.equals("dump")){
			this.dbTest.chooseDBToDump(TicklerVars.dataDir);
		} 
	...
	public void createDebuggable(){
		this.newApk = new NewAPK(TicklerConst.debuggable);
	...
	public void createMitM(){
		this.newApk = new NewAPK(TicklerConst.mitm);
		this.newApk.createNewApk();
	}
	 ...
	 */
	public void version(){
		OutBut.printNormal("Tickler version: "+TicklerVars.version);
	}
	///////////////////// List ////////////////////
