...
public class TicklerCLI {
	...
	public static void main(String[] args) {
		...
		Option info = new Option("info","informationGathering",false,"List information about the app");
		...
		Option disclosure = new Option("squeeze",null,false, "Look for info disclosure in code");
		...
		cli.options.addOption(disclosure);
