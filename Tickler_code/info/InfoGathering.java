...
public class InfoGathering {
	//Search for an installed package on the device
	//syso: true when the user searches for the package, 
	//false when the tool checks that the package exists
//	key = null: don't filter
	...
	public ArrayList<String> getHttpUris(){
		ArrayList<SimpleEntry> hits = this.searcher.search4KeyInDirFName(TicklerVars.smaliDir, "http");
