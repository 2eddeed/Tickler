...
public class ProviderAttacker {
	...
	//Not used now, because of the confusion between URIs from SMALI and URIs from Authority
	public void addContentFromAuthority(Provider prov){
		String uriFromAuth = this.prepareContentFromAuthority(prov);
		if (!this.contentURIs.contains(uriFromAuth)){
			this.checkAndAddUri(uriFromAuth);
		}
	}
